...
DATA_UPDATE_ARGS = [os.environ["THRYVE_FTP_URL"] + "export.7z", "datenspende", "user_id, date, vital_id, device_id"]


def data_update_etl(url: str, schema: str, constraint: str, **kwargs):
    R.pipe(
